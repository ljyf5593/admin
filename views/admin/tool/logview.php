...
<div class="panel">
	...
	<div class="panel-content">
		...
		<form method="get" action="<?php echo Route::url('admin', array('controller' => $request->controller(), 'action' => 'logview'));?>" class="well form-inline ajaxform">
			...
			<?php endif; ?>
			<a class="btn btn-danger ajax" href="<?php echo Route::url('admin', array('controller' => $request->controller(), 'action' => 'deletelog', 'id' => $date)) ?>" data-confirm="你确定要删除此日志文件吗？">delete this file</a>
			</div>
		</form>
