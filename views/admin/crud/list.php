...
<div class="panel">
	<div class="panel-header">
		...
		<div class="actions-bar">
			<div class="btn-group pull-right">
                <?php echo HTML::anchor(Route::url('admin', array('controller' => Request::$current->controller(), 'action'=>'create'), TRUE), __('Create').__($model_name), array('class' => 'btn btn-success btn-mini ajax'));?>
				<a class="btn btn-success btn-mini dropdown-toggle" data-toggle="dropdown">
					<span class="caret"></span>
				</a>
				<ul class="dropdown-menu">
					<li>
						<?php echo HTML::anchor(Route::url('admin', array('controller' => Request::$current->controller(), 'action'=>'create'), TRUE), '<i class="icon-plus"></i>'.__('Create').__($model_name), array('class' => 'ajax'));?>
					</li>
				</ul>
			</div> <!-- // btn-group -->
		</div> <!--	// actions-bar -->
	...
	<?php
		if(!empty($search['search_row'])){
			echo View::factory('admin/search')->bind('search', $search);
		}
	?>
			...
			<table class="table table-bordered table-striped">
				...
				<tr>
					...
					<td>
						...
						<a class="btn btn-mini btn-danger ajax confirm" href="<?php echo Route::url('admin', array('controller'=>Request::$current->controller(), 'action'=>'delete','id'=>$model->pk()));?>"><i class="icon-trash"></i><?php echo __('Delete')?></a>
					</td>
				</tr>
				<?php endforeach;?>
