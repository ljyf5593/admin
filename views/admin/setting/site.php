			...
			<fieldset>
				<div class="control-group">
					...
					<div class="input-append">
						<input type="text" value="<?php echo $config['sitename'];?>" id="sitename" name="sitename" class="input-xlarge">
						<span class="add-on">
				...
				<div class="control-group">
					...
					<div class="input-append">
						<input type="text" id="meta_keywords" name="meta_keywords" class="input-xlarge" value="<?php echo $config['meta_keywords'];?>">
						<span class="add-on">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="3" id="meta_description" name="meta_description" class="input-xlarge"><?php echo $config['meta_description'];?></textarea>
				...
				<div class="control-group alert-danger">
					...
					<div class="controls">
						<label class="radio inline">
							<?php echo Form::radio('closed_site', 'true', $config['closed_site'] == 'true', array('id'=>'closed_site')); echo __('Closed');?>
						</label>
						<label class="radio inline">
							<?php echo Form::radio('closed_site', 'false', $config['closed_site'] == 'false'); echo __('Open');?>
						</label>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<textarea rows="3" id="closed_info" name="closed_info" class="input-xlarge"><?php echo $config['closed_info'];?></textarea>
